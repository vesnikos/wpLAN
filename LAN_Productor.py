...
def header():
    print('Welcome to the Weighted LAN producing Program. This program is going to derive the Lights-At-Night Product '
...
for year in years:
    ...
    with rasterio.Env(GDAL_CACHEMAX=GDAL_CACHEMAX) as env, rasterio.open(
        ...
        # print(ccid_raster.meta)
        # print(lan_1_raster.meta)
        # print(lan_2_raster.meta)
        ...
        def normalize(dstack, nodata):
            ...
            # vnormalize_value = np.vectorize(normalize_value, signature='(m_1,i)->(i)')
            # result = vnormalize_value(dstack)
